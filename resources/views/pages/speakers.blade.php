...
<section id="team" class="section gray-bg">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="section-title wow fadeInUp" data-wow-delay="0s">Others Speakers</h2>
      </div>
      <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="single-member wow fadeInRight" data-wow-delay="0.2s">
          <div class="team-desc">
            ...
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. A enean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
          </div>
          <div class="team-img">
      ...
      <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="single-member wow fadeInLeft" data-wow-delay="0.2s">
          <div class="team-desc">
            <h3>Sophia Tailor</h3>
            <h5>Designer at Google</h5>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. A enean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
          </div>
          <div class="team-img">
...
<div class="ready-to-play">
  <video id="bgvid" class="stop" loop><source src="assets/video/event.webm" type="video/mp4"></video>
    <div id="polina" class="video-text">
      <div class="tb-t">
        <div class="tb-c">
          <div class="polina"><button><i class='icon-control-play'></i></button></div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="speakers-member wow fadeIn" data-wow-delay="0.9s">
            ...
            <div class="member-desc">
              <h3>Lamba Kureshi</h3>
              <h5>Senior Professor,Boston University</h5>
              <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those intereste.</p>
              <div class="social-icon">
                <a class="social" href="#" target="_blank"><i class="fa fa-facebook"></i></a>
                <a class="social" href="#" target="_blank"><i class="fa fa-twitter"></i></a>
      ...
      <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12">
          <div class="content-text">
            ...
            <p class="text">All of our virtual professionals are highly experienced in the areas in which they work and have been through a thorough recruitment process.</p>
          </div>
        </div>
